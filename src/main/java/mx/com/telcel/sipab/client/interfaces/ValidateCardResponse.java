...
/**
 * <p>Clase Java para ValidateCardResponse complex type.
 * 
 ...
 *         &lt;element name="validateCardResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}ValidateCardRespType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ValidateCardResponse {
    ...
    @XmlElement(required = true)
    protected ValidateCardRespType validateCardResponse;
    ...
    /**
     * Obtiene el valor de la propiedad validateCardResponse.
     * 
     * @return
     *     possible object is
     *     {@link ValidateCardRespType }
     *     
     */
    public ValidateCardRespType getValidateCardResponse() {
        return validateCardResponse;
    }

    /**
     * Define el valor de la propiedad validateCardResponse.
     * 
     * @param value
     *     allowed object is
     *     {@link ValidateCardRespType }
     *     
     */
    public void setValidateCardResponse(ValidateCardRespType value) {
        this.validateCardResponse = value;
    }
