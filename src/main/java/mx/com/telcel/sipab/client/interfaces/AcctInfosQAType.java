...
/**
 * <p>Clase Java para AcctInfosQAType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="AcctInfosQAType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="acctCode" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}AcctCodeType"/&gt;
 *         &lt;element name="acctId" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}AcctIdType" minOccurs="0"/&gt;
 *         &lt;element name="acctName" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}AcctNameType"/&gt;
 *         &lt;element name="acctClass" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}AcctClassType"/&gt;
 *         &lt;element name="pAcctId" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}PAcctIdType" minOccurs="0"/&gt;
 *         &lt;element name="payment" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}PaymentType" minOccurs="0"/&gt;
 *         &lt;element name="paymentMethod" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}PaymentMethodType" minOccurs="0"/&gt;
 *         &lt;element name="currencyId" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}CurrencyIdQAType" minOccurs="0"/&gt;
 *         &lt;element name="billCycleTypeId" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}BillCycleTypeIdType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="collectionProcessFlag" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}CollectionProcessFlagListType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="dunningFlag" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}DunningFlagType" minOccurs="0"/&gt;
 *         &lt;element name="billLang" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}LanguageType" minOccurs="0"/&gt;
 *         &lt;element name="regionCode" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}RegionCodeType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="regimenFiscal" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}RegimenFiscalType" minOccurs="0"/&gt;
 *         &lt;element name="CFDIServicio" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}CFDIServicioType" minOccurs="0"/&gt;
 *         &lt;element name="CFDIEquipo" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}CFDIEquipoType" minOccurs="0"/&gt;
 *         &lt;element name="acctProperty" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}BesCrmSimplePropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AcctInfosQAType", propOrder = {
    "acctCode",
    "acctId",
    "acctName",
    "acctClass",
...
public class AcctInfosQAType {
    ...
    protected List<BesCrmSimplePropertyType> acctProperty;
     ...
     * 
     */
    public List<BesCrmSimplePropertyType> getAcctProperty() {
        if (acctProperty == null) {
            acctProperty = new ArrayList<BesCrmSimplePropertyType>();
        }
