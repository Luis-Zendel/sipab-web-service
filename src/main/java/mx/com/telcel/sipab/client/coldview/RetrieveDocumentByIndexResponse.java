...
/**
 * <p>Clase Java para RetrieveDocumentByIndexResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RetrieveDocumentByIndexResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RetrieveDocumentByIndexResponse", propOrder = {
    "resRetrieveDocByIndex"
})
public class RetrieveDocumentByIndexResponse {
