...
/**
 * <p>Clase Java para GetOrderDetailInfoResponse complex type.
 * 
 ...
 *         &lt;element name="getOrderDetailInfoResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}GetOrderDetailInfoRespType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetOrderDetailInfoResponse {
    ...
    protected GetOrderDetailInfoRespType getOrderDetailInfoResponse;
    ...
    /**
     * Obtiene el valor de la propiedad getOrderDetailInfoResponse.
     * 
     * @return
     *     possible object is
     *     {@link GetOrderDetailInfoRespType }
     *     
     */
    public GetOrderDetailInfoRespType getGetOrderDetailInfoResponse() {
        return getOrderDetailInfoResponse;
    }

    /**
     * Define el valor de la propiedad getOrderDetailInfoResponse.
     * 
     * @param value
     *     allowed object is
     *     {@link GetOrderDetailInfoRespType }
     *     
     */
    public void setGetOrderDetailInfoResponse(GetOrderDetailInfoRespType value) {
        this.getOrderDetailInfoResponse = value;
    }
