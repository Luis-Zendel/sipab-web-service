...
/**
 * <p>Clase Java para GetSubscriberInfoResponse complex type.
 * 
 ...
 *         &lt;element name="getSubscriberInfoResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/customermanagementservice}GetSubscriberInfoRespType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetSubscriberInfoResponse {
    ...
    @XmlElement(required = true)
    protected GetSubscriberInfoRespType getSubscriberInfoResponse;
    ...
    /**
     * Obtiene el valor de la propiedad getSubscriberInfoResponse.
     * 
     * @return
     *     possible object is
     *     {@link GetSubscriberInfoRespType }
     *     
     */
    public GetSubscriberInfoRespType getGetSubscriberInfoResponse() {
        return getSubscriberInfoResponse;
    }

    /**
     * Define el valor de la propiedad getSubscriberInfoResponse.
     * 
     * @param value
     *     allowed object is
     *     {@link GetSubscriberInfoRespType }
     *     
     */
    public void setGetSubscriberInfoResponse(GetSubscriberInfoRespType value) {
        this.getSubscriberInfoResponse = value;
    }
