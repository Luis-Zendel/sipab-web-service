...
/**
 * <p>Clase Java para AttributeListType complex type.
 * 
 ...
 *         &lt;element name="attributeCode" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}CadenaAlfanumerica64Type"/&gt;
 ...
 *         &lt;element name="childAttrList" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}ChildAttrListType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AttributeListType {
    ...
    protected List<ChildAttrListType> childAttrList;
     ...
     * {@link ChildAttrListType }
     * 
     * 
     */
    public List<ChildAttrListType> getChildAttrList() {
        if (childAttrList == null) {
            childAttrList = new ArrayList<ChildAttrListType>();
        }
