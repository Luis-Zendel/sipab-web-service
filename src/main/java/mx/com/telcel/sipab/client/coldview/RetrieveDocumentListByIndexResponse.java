...
/**
 * <p>Clase Java para RetrieveDocumentListByIndexResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RetrieveDocumentListByIndexResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RetrieveDocumentListByIndexResponse", propOrder = {
    "requestResultsInvoiceList"
})
public class RetrieveDocumentListByIndexResponse {
