...
/**
 * <p>Clase Java para ModifyCustInfoForDOLRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ModifyCustInfoForDOLRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ModifyCustInfoForDOLRespType", propOrder = {
    "createOrderResponse"
})
public class ModifyCustInfoForDOLRespType {
