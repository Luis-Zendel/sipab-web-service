...
/**
 * <p>Clase Java para LifeCycleChgInfo2Type complex type.
 * 
 ...
 *         &lt;element name="chgValidity" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/esb/arservices}EnteroType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class LifeCycleChgInfo2Type {
    ...
    /**
     * Obtiene el valor de la propiedad chgValidity.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    /**
     * Define el valor de la propiedad chgValidity.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
