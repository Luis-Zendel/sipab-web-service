...
/**
 * <p>Clase Java para RetrieveDocumentListByIndexCFDI_NCRResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RetrieveDocumentListByIndexCFDI_NCRResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RetrieveDocumentListByIndexCFDI_NCRResponse", propOrder = {
    "requestResultsInvoiceList"
})
public class RetrieveDocumentListByIndexCFDINCRResponse {
