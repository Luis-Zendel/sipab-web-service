...
/**
 * <p>Clase Java para TroubleTicketServiceException complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="TroubleTicketServiceException"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TroubleTicketServiceException", propOrder = {
    "controlData",
    "detailFail"
})
public class TroubleTicketServiceException {
