...
/**
 * <p>Clase Java para GetSubsCustAcctBasicInfoPetType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GetSubsCustAcctBasicInfoPetType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetSubsCustAcctBasicInfoPetType", propOrder = {
    "serviceNumber",
    "subscriberId"
})
public class GetSubsCustAcctBasicInfoPetType {
