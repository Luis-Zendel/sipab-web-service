...
/**
 * <p>Clase Java para GenerateDepositRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GenerateDepositRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GenerateDepositRespType", propOrder = {
    "createOrderResponse"
})
public class GenerateDepositRespType {
