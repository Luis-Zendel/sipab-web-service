...
/**
 * <p>Clase Java para SpecialChangeOfferingRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="SpecialChangeOfferingRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SpecialChangeOfferingRespType", propOrder = {
    "createOrderResponse"
})
public class SpecialChangeOfferingRespType {
