...
/**
 * <p>Clase Java para SwapResourceRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="SwapResourceRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SwapResourceRespType", propOrder = {
    "createOrderResponse"
})
public class SwapResourceRespType {
