...
/**
 * <p>Clase Java para SwapResourceResponse complex type.
 * 
 ...
 *         &lt;element name="swapResourceResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}SwapResourceRespType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SwapResourceResponse {
    ...
    @XmlElement(required = true)
    protected SwapResourceRespType swapResourceResponse;
    ...
    /**
     * Obtiene el valor de la propiedad swapResourceResponse.
     * 
     * @return
     *     possible object is
     *     {@link SwapResourceRespType }
     *     
     */
    public SwapResourceRespType getSwapResourceResponse() {
        return swapResourceResponse;
    }

    /**
     * Define el valor de la propiedad swapResourceResponse.
     * 
     * @param value
     *     allowed object is
     *     {@link SwapResourceRespType }
     *     
     */
    public void setSwapResourceResponse(SwapResourceRespType value) {
        this.swapResourceResponse = value;
    }
