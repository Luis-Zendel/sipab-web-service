...
/**
 * <p>Clase Java para ReturnResourceResponse complex type.
 * 
 ...
 *         &lt;element name="returnResourceResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/crm/esb/telcelinterfaceservices}ReturnResourceRespType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ReturnResourceResponse {
    ...
    @XmlElement(required = true)
    protected ReturnResourceRespType returnResourceResponse;
    ...
    /**
     * Obtiene el valor de la propiedad returnResourceResponse.
     * 
     * @return
     *     possible object is
     *     {@link ReturnResourceRespType }
     *     
     */
    public ReturnResourceRespType getReturnResourceResponse() {
        return returnResourceResponse;
    }

    /**
     * Define el valor de la propiedad returnResourceResponse.
     * 
     * @param value
     *     allowed object is
     *     {@link ReturnResourceRespType }
     *     
     */
    public void setReturnResourceResponse(ReturnResourceRespType value) {
        this.returnResourceResponse = value;
    }
