...
/**
 * <p>Clase Java para PaperLessNotificationForContractRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PaperLessNotificationForContractRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PaperLessNotificationForContractRespType", propOrder = {
    "resultCode",
    "resultDescription"
})
public class PaperLessNotificationForContractRespType {
