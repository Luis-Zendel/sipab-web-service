...
/**
 * <p>Clase Java para ManageFnFRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ManageFnFRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ManageFnFRespType", propOrder = {
    "createOrderResponse"
})
public class ManageFnFRespType {
