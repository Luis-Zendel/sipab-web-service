...
/**
 * <p>Clase Java para RetrieveDocumentListByIndexCFDI_CPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RetrieveDocumentListByIndexCFDI_CPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RetrieveDocumentListByIndexCFDI_CPResponse", propOrder = {
    "requestResultsInvoiceList"
})
public class RetrieveDocumentListByIndexCFDICPResponse {
