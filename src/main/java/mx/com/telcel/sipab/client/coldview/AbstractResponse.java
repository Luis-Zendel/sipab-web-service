...
/**
 * <p>Clase Java para abstractResponse complex type.
 * 
...
@XmlSeeAlso({
    InformationResponse2 .class,
    ResRetrieveDocByIndex.class,
    RequestResultsInvoiceList.class,
    ResCancelDocument.class
})
