...
/**
 * <p>Clase Java para RetrieveDocumentByIndexCFDI_NCRResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RetrieveDocumentByIndexCFDI_NCRResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RetrieveDocumentByIndexCFDI_NCRResponse", propOrder = {
    "resRetrieveDocByIndex"
})
public class RetrieveDocumentByIndexCFDINCRResponse {
