...
/**
 * <p>Clase Java para GetProductSVAPetType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GetProductSVAPetType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetProductSVAPetType", propOrder = {
    "serviceNumber"
})
public class GetProductSVAPetType {
