...
/**
 * <p>Clase Java para StartDeliveryNotifyRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="StartDeliveryNotifyRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "StartDeliveryNotifyRespType", propOrder = {
    "resultCode",
    "resultDescription"
})
public class StartDeliveryNotifyRespType {
