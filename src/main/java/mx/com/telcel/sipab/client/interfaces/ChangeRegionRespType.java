...
/**
 * <p>Clase Java para ChangeRegionRespType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ChangeRegionRespType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ChangeRegionRespType", propOrder = {
    "response"
})
public class ChangeRegionRespType {
